...
#define C2_GPIOZ_PIN_START		(C2_GPIO_PIN_BASE + 115)
#define C2_GPIOZ_PIN_END		(C2_GPIO_PIN_BASE + 130)

#define C2_GPIOZ_FSEL_REG_OFFSET	0x115
#define C2_GPIOZ_OUTP_REG_OFFSET	0x116
#define C2_GPIOZ_INP_REG_OFFSET		0x117
#define C2_GPIOZ_PUPD_REG_OFFSET	0x14b
#define C2_GPIOZ_PUEN_REG_OFFSET	0x13d
